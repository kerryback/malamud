...
- Creatives Venture Fund, Office of Research
...
- Neural Networks: Interpret deep vs. shallow learning architectures and their application to financial data. 
...
- Overfitting, Double Descent, Model Complexity, and Inductive Biases

### [Tuesday, Sept 23](lecture2.qmd)
- Regularization, Model Selection, Sparsity, Non-Linearities, and Random Features

### [Wednesday, Sept 24](lecture3.qmd)
- Implicit Regularization, The Virtue of Complexity, The Magic of High Dimensions
- Basics of Random Matrix Theory

### [Thursday, Sept 25](lecture4.qmd)
- Kernel Methods, Shallow Learning, Curse of Dimensionality
...
- High-Dimensional Factor Models, Portfolio Tangent Kernel, and the Complexity Wedge

### [Wednesday, Oct 1](lecture7.qmd)
- Bayesian Learning, Gaussian Processes and Equilibrium Models in High Dimensions
